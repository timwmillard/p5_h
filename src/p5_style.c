...
void draw() {
    ...
    for (int i = 0; i < 4; i++) {
        ...
        p5_fill_rgb((unsigned int)(r * 255), (unsigned int)(g * 255), (unsigned int)(b * 255));
        p5_no_stroke();
        p5_circle(x, y, 40.0f);
    }

...
#define P5_NO_APP          // Disable automatic app setup, use manual sokol
#include "../p5.h"
...
void frame() {
    ...
    p5_fill_rgb(1.0f*255, 0.5f*255, 0.2f*255);
    p5_stroke_rgb(1.0f*255, 1.0f*255, 1.0f*255);
    ...
    p5_fill_rgb(0.2f*255, 1.0f*255, 0.5f*255);
    p5_stroke_rgb(0.0f, 0.0f, 0.0f);
    p5_triangle(-40.0f, 20.0f, 40.0f, 20.0f, 0.0f, -30.0f);
    p5_pop();
    
    // lines pattern
    p5_stroke_rgb(0.7f*255, 0.3f*255, 0.9f*255);
    for (int i = 0; i < 10; i++) {
